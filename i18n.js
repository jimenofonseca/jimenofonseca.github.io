var TRANSLATIONS = {
  en: {
    ...
    'transf.cs2':                 'We ran this as expectation management and process transformation, not as a software architecture problem. New technological services were introduced at a deliberately low margin until their value was visible, and the work started from the immediate downstream pain of the construction teams rather than from the preferences of whoever held the budget.',
    ...
    'v2.about.proof2.label':      'Budget and P&L oversight',
    'about.proof2':               'Manage an OPEX/CAPEX budget of CHF 8m, transitioning digital initiatives from pure cost centres into protected business value.',
    ...
    'about.out1.impact':          'Transitioned internal engineering capabilities into market-facing products, a transformation that secured CHF 30m in at-risk business and launched CHF 1.5m in net-new digital services.',
    ...
    'about.out3.impact':          'Contributed data to the IPCC 6th Assessment Report on Climate Change, informing worldwide environmental policy since 2021.',
    ...
    'v2.about.p5.sum':            'Introduce services at low margins until their value is proven, turning IT from a pure cost centre into protected business value.',
    'about.p5':                   'In utilities, IT budget is read as OPEX — a cost — rather than CAPEX invested in something physical. That position on the balance sheet is why technology struggles to earn the recognition, and the maintenance budget, that it needs. My approach is to introduce new technological services at a deliberately low margin until the value is visible: a new capability, a better quality of service, information the business did not have before. Once it is visible, the service becomes part of the critical value that gets protected at all costs. The cost is not infinite either — to keep development at a sustainable pace I make the organisational changes that let us secure excellent capability, nationally and internationally, at genuinely good value.',
  ...
  de: {
    ...
    'transf.cs2':                 'Wir haben das als Erwartungsmanagement und Prozesstransformation geführt, nicht als Frage der Softwarearchitektur. Neue technologische Dienstleistungen wurden bewusst mit geringer Marge eingeführt, bis ihr Wert sichtbar war, und die Arbeit begann beim unmittelbaren Schmerz der Bauteams, nicht bei den Vorlieben derjenigen, die das Budget hielten.',
    ...
    'v2.about.proof2.label':      'Budget- und Ergebnisverantwortung',
    'about.proof2':               'Verantwortung für ein OPEX/CAPEX-Budget von CHF 8 Mio. und die Überführung digitaler Initiativen von reinen Kostenstellen zu geschütztem Geschäftswert.',
    ...
    'about.out1.impact':          'Interne Engineering-Fähigkeiten in marktfähige Produkte überführt — eine Transformation, die CHF 30 Mio. an gefährdetem Geschäft gesichert und CHF 1,5 Mio. an neuen digitalen Dienstleistungen gestartet hat.',
    ...
    'about.out3.impact':          'Daten zum 6. IPCC-Sachstandsbericht zum Klimawandel beigesteuert, die seit 2021 die weltweite Umweltpolitik prägen.',
    ...
    'v2.about.p5.sum':            'Dienstleistungen mit geringer Marge einführen, bis ihr Wert bewiesen ist — so wird aus IT als reinem Kostenblock geschützter Geschäftswert.',
    'about.p5':                   'In der Versorgungswirtschaft gilt IT-Budget als OPEX — als Kosten — und nicht als CAPEX, das in etwas Physisches investiert wird. Diese Position in der Bilanz ist der Grund, warum Technologie sich die Anerkennung und das Wartungsbudget, die sie braucht, nur schwer verdient. Mein Ansatz ist, neue technologische Dienstleistungen bewusst mit geringer Marge einzuführen, bis der Wert sichtbar wird: eine neue Fähigkeit, eine bessere Servicequalität, Informationen, die das Geschäft vorher nicht hatte. Ist er sichtbar, wird die Dienstleistung Teil des kritischen Werts, der um jeden Preis geschützt wird. Auch dieser Preis ist nicht unendlich — um ein nachhaltiges Entwicklungstempo zu halten, stosse ich die organisatorischen Veränderungen an, die es uns erlauben, hervorragende Fähigkeiten national wie international zu wirklich gutem Wert zu sichern.',
