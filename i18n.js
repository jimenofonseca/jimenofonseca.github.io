var TRANSLATIONS = {
  en: {
    ...
    'v2.ipcc.caption.text':       'Example output from the HBLM-USA and DEG-USA forecasting models',
  ...
  de: {
    ...
    'v2.ipcc.caption.text':       'Beispielhafte Ausgabe der Prognosemodelle HBLM-USA und DEG-USA',
