var TRANSLATIONS = {
  en: {
    ...
    'hero.proof':         'I started in software; today I lead Digital Engineering at Axpo Grid in Switzerland, where I built the department bringing BIM and digital twins to the construction and operation of power networks — including the first substation in the DACH region built without a single paper plan. Before that I created City Energy Analyst, an open-source urban energy simulation platform now used in 75+ countries. It has kept running since I handed it over to the open-source community. I also co-founded Superurbana GmbH, which commercialised that work until 2025.',
    'hero.creds':         'PhD from ETH Zürich, certified Agile Practitioner, active member of CIGRE, and contributor of data to the IPCC 6th Assessment Report on Climate Change.',
    ...
    'v2.os.title':                'Insights for the IPCC 6th Assessment Report',
    'v2.os.lede':                 'Two forecasting models quantifying how climate change moves energy demand — data contributed to the 2021 IPCC 6th Assessment Report.',
    'os.desc':                    'Jimeno Fonseca\'s HBLM-USA and DEG-USA forecasting models analysed energy consumption across one million buildings in the United States, and contributed data to the IPCC 6th Assessment Report on Climate Change.',
    ...
    'os.cs3':                     'Both models were built with deep neural networks and Bayesian statistics, run across one million buildings spanning the entire United States, and published in peer-reviewed journals. The resulting demand scenarios were submitted to the IPCC 6th Assessment Report panel, which aggregated them with those of more than 15 other selected teams and published the averaged projections in the report.',
  ...
  de: {
    ...
    'hero.proof':         'Ich komme aus der Softwareentwicklung; heute leite ich Digital Engineering bei Axpo Grid in der Schweiz, wo ich die Abteilung aufgebaut habe, die BIM und digitale Zwillinge in den Bau und Betrieb von Stromnetzen bringt — darunter das erste Unterwerk der DACH-Region, das ohne einen einzigen Papierplan gebaut wurde. Davor habe ich City Energy Analyst entwickelt, eine Open-Source-Plattform für urbane Energiesimulation, die heute in über 75 Ländern eingesetzt wird. Sie läuft weiter, seit ich sie an die Open-Source-Community übergeben habe. Ausserdem habe ich Superurbana GmbH mitgegründet, die diese Arbeit bis 2025 kommerzialisiert hat.',
    'hero.creds':         'Doktortitel der ETH Zürich, zertifizierter Agile Practitioner, aktives Mitglied von CIGRE und Datenbeitragender zum 6. IPCC-Sachstandsbericht zum Klimawandel.',
    ...
    'v2.os.title':                'Erkenntnisse für den 6. IPCC-Sachstandsbericht',
    'v2.os.lede':                 'Zwei Prognosemodelle, die quantifizieren, wie der Klimawandel den Energiebedarf verschiebt — Daten, die zum 6. IPCC-Sachstandsbericht 2021 beigesteuert wurden.',
    'os.desc':                    'Die Prognosemodelle HBLM-USA und DEG-USA von Jimeno Fonseca haben den Energieverbrauch von einer Million Gebäuden in den USA analysiert und Daten zum 6. IPCC-Sachstandsbericht zum Klimawandel beigesteuert.',
