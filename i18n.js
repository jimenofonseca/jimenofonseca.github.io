var TRANSLATIONS = {
  en: {
    ...
    'hero.creds':         'PhD from ETH Zürich, certified Agile Practitioner, active member of CIGRE, and past contributor to the IPCC 6th Assessment Report on Climate Change.',
    ...
    'os.cs3':                     'Both models were built with deep neural networks and Bayesian statistics and run across one million buildings spanning the entire United States. The work rests on more than a decade of research at ETH Zürich and the ETH-Singapore Centre, with each component put through peer review before it was assembled.',
    ...
    'about.out3.impact':          'The findings, models and underlying data form part of the IPCC 6th Assessment Report on Climate Change, informing worldwide environmental policy since 2021.',
  ...
  de: {
    ...
    'hero.creds':         'Doktortitel der ETH Zürich, zertifizierter Agile Practitioner, aktives Mitglied von CIGRE und ehemaliger Mitwirkender am 6. IPCC-Sachstandsbericht zum Klimawandel.',
    ...
    'os.cs3':                     'Beide Modelle wurden mit tiefen neuronalen Netzen und Bayesscher Statistik gebaut und über eine Million Gebäude in den gesamten USA gerechnet. Die Arbeit stützt sich auf über ein Jahrzehnt Forschung an der ETH Zürich und am ETH-Singapore Centre; jede Komponente durchlief ein Peer-Review, bevor sie zusammengesetzt wurde.',
    ...
    'about.out3.impact':          'Die Erkenntnisse, Modelle und zugrunde liegenden Daten sind Teil des 6. IPCC-Sachstandsberichts zum Klimawandel und prägen seit 2021 die weltweite Umweltpolitik.',
