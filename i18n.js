var TRANSLATIONS = {
  en: {
    ...
    'transf.cs3':                 'I built the vision and strategy to carry BIM and digital twins into a group of 400 stakeholders — asset managers, engineers, procurement and sales officers — and stood up a new department to own them, with a team built overseas to sustain delivery. Every capability went in alongside the process change it required and the training that came with it, because the tooling was never what decided adoption.',
  ...
  de: {
    ...
    'cea.cs3':                    'Ich habe die Entwicklung von CEA an der ETH Zürich und am ETH-Singapore Centre begleitet und es von einem persönlichen Forschungsinstrument zu einem Open-Source-Projekt mit über 40 Mitwirkenden in mehreren Ländern gemacht. Beratung und CEA-Schulungen in Europa und im Nahen Osten finanzierten die Wartung, die Forschungsgelder allein nie getragen hätten, und das Projekt wurde an die nächste Generation von Promovierenden an der ETH Zürich übergeben, statt zu verfallen.',
