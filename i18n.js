var TRANSLATIONS = {
  en: {
    ...
    'v2.stat.paperless':  'Substation digitally built in CH',
    'v2.stat.depts':      'MCHF secured',
    ...
    'v2.pub.lede':                'Contributions to science and broader knowledge on energy systems and digitalization.',
    ...
    'os.p1':              'I believe science and engineering advance fastest when models, data, and methods are open and reproducible. Across more than a decade of research at ETH Zürich and the ETH-Singapore Centre, and through my own ventures, I have built and contributed to open-source tools that are now used in 25+ countries and have shaped international policy — including contributions to the IPCC 6th Assessment Report on Climate Change.',
  ...
  de: {
    ...
    'v2.stat.paperless':  'Unterwerk digital erbaut in der CH',
    'v2.stat.depts':      'MCHF gesichert',
    ...
    'v2.pub.lede':                'Beiträge zur Wissenschaft und zum breiteren Verständnis von Energiesystemen und Digitalisierung.',
    ...
    'cea.p1':             'Was 2013 als ein paar Zeilen Python während meiner Promotion an der ETH Zürich begann, ist zu einem globalen Standard für Open-Source-Analyse urbaner Energiesysteme geworden. City Energy Analyst (CEA) wird heute in über 25 Ländern von mehr als tausend Ingenieuren, Forschenden und Stadtplanern genutzt — eine Reichweite, die mich noch immer überrascht, für ein Werkzeug aus einem akademischen Labor.',
    ...
    'transf.p2':          'Bei Axpo Grid habe ich eine Vision und Strategie entwickelt, um BIM und digitale Zwillinge in unser Team von 400 Stakeholdern zu bringen — Asset Managern, Ingenieuren, Beschaffungs- und Vertriebsmitarbeitern. In drei Jahren haben wir uns am Markt neu positioniert und als Erste in der Schweiz ein Hochspannungs-Unterwerk allein mit 3D-Informationsmodellen realisiert (keine Pläne, kein Drucken). Eine komplett neue Abteilung wurde aufgebaut, ein Team im Ausland etabliert und neue kommerzielle Dienstleistungen geschaffen.',
