var TRANSLATIONS = {
  en: {
    ...
    'ipcc.cs2':                     'Science and engineering advance fastest when models, data and methods are open and reproducible. Both models were therefore built to be transparent and highly scalable, and released openly, so the method could be examined rather than taken on trust.',
    'ipcc.cs3':                     'Both models were built with deep neural networks and Bayesian statistics, run across one million buildings spanning the entire United States, and published in peer-reviewed journals. The resulting demand scenarios were submitted to the IPCC 6th Assessment Report panel, which aggregated them with those of more than 15 other selected teams and published the averaged projections in the report.',
  ...
  de: {
    ...
    'ipcc.cs2':                     'Wissenschaft und Technik schreiten am schnellsten voran, wenn Modelle, Daten und Methoden offen und reproduzierbar sind. Beide Modelle wurden deshalb transparent und hoch skalierbar gebaut und offen veröffentlicht, damit die Methode geprüft und nicht auf Treu und Glauben hingenommen werden muss.',
    'ipcc.cs3':                     'Beide Modelle wurden mit tiefen neuronalen Netzen und Bayesscher Statistik gebaut, über eine Million Gebäude in den gesamten USA gerechnet und in peer-reviewten Fachzeitschriften veröffentlicht. Die daraus entstandenen Nachfrageszenarien wurden beim Gremium des 6. IPCC-Sachstandsberichts eingereicht, das sie mit denen von über 15 weiteren ausgewählten Teams zusammenführte und die gemittelten Projektionen im Bericht veröffentlichte.',
